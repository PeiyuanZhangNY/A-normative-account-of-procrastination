...
figure
subplot(1,2,1)
plot(1:10,WithoptActSeqMatrix(1:10,2),'o-','Color',greencolor(1,:));
hold on
%plot(1:T,WithoptActSeqMatrix(:,1),'o--','Color',redcolor(2,:));
%hold on
plot(1:10,WithoptActSeqMatrix(1:10,3),'o-','Color',greencolor(2,:));
hold on
plot(1:10,WithoptActSeqMatrix(1:10,4),'o-','Color',greencolor(3,:));
hold off
...
xticks(1:2:TVec(end))
ylim([0 0.3])
set(gca, 'XTick', 1:2:TVec(end));
box off
set(gca,'TickDir','out');

subplot(1,2,2)
plot(1:TVec(end),WithoptActSeqMatrix(1:TVec(end),14),'o-','Color',greencolor(4,:));
hold on
plot(1:TVec(end),WithoptActSeqMatrix(1:TVec(end),15),'o-','Color',greencolor(5,:));
hold on
plot(1:TVec(end),WithoptActSeqMatrix(1:TVec(end),end),'o-','Color',greencolor(6,:));
hold off
legend('T=15','T=16','T=20','Interpreter','tex')
legend boxoff
xlabel('time \itt','Interpreter','tex')
%ylabel('progress \Delta\its','Interpreter','tex')
