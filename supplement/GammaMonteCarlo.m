...
gammaAll = nan(2,NMonte);
gammaAll(1,:) = rand(1,NMonte);
gammaAll(2,:) = gammaAll(1,:)+(1-gammaAll(1,:)).*rand(1,NMonte);
...
for nMonte = 1: NMonte
    nMonte
    [temp1,] = OptActStateSeq( deltas,TAll(nMonte),k,JAll(nMonte),c1All(nMonte),lambdaAll(nMonte),gammaAll(1,nMonte),alphaAll(nMonte),betaAll(nMonte)); 
    ...
    [temp2,] = OptActStateSeq( deltas,TAll(nMonte),k,JAll(nMonte),c1All(nMonte),lambdaAll(nMonte),gammaAll(2,nMonte),alphaAll(nMonte),betaAll(nMonte)); 
