...
for nMonte = 1: NMonte
    nMonte
    [temp1,] = HyperbolicDiscountingFun(TAll(nMonte),k,JAll(nMonte),c1All(1,nMonte),lambdaAll(nMonte),alphaAll(nMonte),betaAll(nMonte),k_DR(nMonte)); 
    ...
    [temp2,] = HyperbolicDiscountingFun(TAll(nMonte),k,JAll(nMonte),c1All(2,nMonte),lambdaAll(nMonte),alphaAll(nMonte),betaAll(nMonte),k_DR(nMonte)); 
...
% find(b<0) If no,  Yes. b>=0 always 

% save('Hyperbolic_CmaxMonteCarlo_J0.mat')
% save('Hyperbolic_CmaxMonteCarlo_Jnonzero.mat')
