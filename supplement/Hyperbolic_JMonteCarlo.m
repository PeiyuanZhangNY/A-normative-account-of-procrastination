...
for nMonte = 1: NMonte
    nMonte
    [temp1,] = HyperbolicDiscountingFun(TAll(nMonte),k,JAll(1,nMonte),c1All(nMonte),lambdaAll(nMonte),alphaAll(nMonte),betaAll(nMonte),k_DR(nMonte)); 
    ...
    [temp2,] = HyperbolicDiscountingFun(TAll(nMonte),k,JAll(2,nMonte),c1All(nMonte),lambdaAll(nMonte),alphaAll(nMonte),betaAll(nMonte),k_DR(nMonte)); 
