...
for nMonte = 1: NMonte
    nMonte
    [temp1,] = HyperbolicDiscountingFun(TAll(1,nMonte),k,JAll(nMonte),c1All(nMonte),lambdaAll(nMonte),alphaAll(1,nMonte),betaAll(nMonte),k_DR(nMonte)); 
    [temp2,] = HyperbolicDiscountingFun(TAll(2,nMonte),k,JAll(nMonte),c1All(nMonte),lambdaAll(nMonte),alphaAll(1,nMonte),betaAll(nMonte),k_DR(nMonte)); 
...
% save('Hyperbolic_TMonteCarlo.mat')
